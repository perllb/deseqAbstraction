...
#' GO_topGO_geneSet(dabs = dabs,species = "hsa",BP=T,MF=F,CC=F,geneSet=geneSet)



GO_topGO_geneSet <- function(dabs=NULL,geneSet=NULL,species="hsa",term="BP",nodeSize=5) {
...
geneSet <- res[!is.na(res$padj) & res$padj<0.01,]$entrez
GO_topGO(dabs = dabs,genes = geneSet)
